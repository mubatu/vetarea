...
export const services = [
  {
    ...
    title: "Genel muayene",
    description:
      "Dostunuzun ihtiyaçlarını dinliyor, ayrıntılı muayene ile doğru bakım planını birlikte oluşturuyoruz.",
  },
  {
    number: "02",
    title: "Koruyucu sağlık",
    description:
      "Aşı, iç-dış parazit uygulamaları ve düzenli kontrollerle sağlıklı günlerin devamını destekliyoruz.",
  },
  {
    number: "03",
    title: "Laboratuvar",
    description:
      "Tanı sürecini destekleyen kan ve laboratuvar incelemelerini klinik ihtiyaçlarına göre planlıyoruz.",
  },
  {
    number: "04",
    title: "Görüntüleme",
    description:
      "Röntgen ve ultrason gibi görüntüleme yöntemleriyle klinik bulguları daha yakından değerlendiriyoruz.",
  },
  {
    number: "05",
    title: "Cerrahi",
    description:
      "Operasyon öncesinden iyileşme sürecine kadar kontrollü, açık ve özenli bir yaklaşım sunuyoruz.",
  },
  {
    number: "06",
    title: "Mikroçip & pasaport",
    description:
      "Kimliklendirme, mikroçip ve seyahat süreçlerinde gerekli uygulamalar için size yol gösteriyoruz.",
  },
] as const;
